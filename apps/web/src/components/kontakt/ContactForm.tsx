// components/kontakt/ContactForm.tsx
"use client";
...
type TimeWindow = "09-12" | "12-15" | "15-18" | "18-20";
...
export function ContactForm() {
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const payload = {
      ...
      preferredTime: String(form.get("preferredTime") ?? ""), // optional
          ...
          <div className="mb-4 flex items-center justify-between gap-3">
            <div>
              ...
              <div className="mt-1 text-xs text-white/60">
                MVP: Wir bestätigen den Termin per E-Mail/Telefon. Später kann
                das direkt mit Kalender/Payload synchronisiert werden.
              </div>
            </div>
          </div>
